...
class DebtManage():
	def __init__(self):
		...
		self.inbox_dir  = '/home/shieber/practice/automation/bill/inbox.txt'  #暂存邮件的位置
		self.excel_dir  = '/home/shieber/practice/automation/bill/'		      #excel存放路径 
...
class EmailManage():
	...
	def __init__(self):
		...
		self.inbox_dir   = '/home/shieber/practice/automation/bill/inbox.txt' 
		self.pop3_server = 'pop.163.com'         #对应邮箱的pop3服务器
		self.email_addr  = "18381373030@163.com" #你的邮箱账号
		self.password    = "#*love520*#sl"       #你的登录密码
